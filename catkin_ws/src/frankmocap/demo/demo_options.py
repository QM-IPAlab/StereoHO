...
class DemoOptions():
    ...
    def __init__(self):
        ...
        parser.add_argument('--mask4obj', action='store_true', help='whether to use mask for object detection')
        parser.add_argument('--mask4objhand', action='store_true', help='whether to use mask for object detection')
