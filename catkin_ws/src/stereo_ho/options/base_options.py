...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataset_dir', type=str, default='', help='dataset dir')
        self.parser.add_argument('--num_gpus', type=int, default=1, help='number of GPUs to use')

        # log stuff
        self.parser.add_argument('--base_path', type=str, default='/jmain02/home/J2AD007/txk47/yxp53-txk47/', help='path containing projects and datasets')
        ...
        self.parser.add_argument('--mlp_decoder', type=int, default=1, help='Whether to use MLP decoder')
        ...
        self.parser.add_argument('--loss', type=str, default='ce', help='loss function type: ce | cce | focal')
        self.parser.add_argument('--focal_gamma', type=float, default=2.0, help='focal gamma')
        self.parser.add_argument('--focal_alpha', type=float, default=0.25, help='focal alpha')
        self.parser.add_argument('--empty_idx_h', type=int, default=0, help='empty idx for hand')
        self.parser.add_argument('--empty_idx_o', type=int, default=0, help='empty idx for object')
        ...
        self.parser.add_argument('--vq_ckpt_h', type=str, default=None, help='vq ckpt to load.')
        self.parser.add_argument('--vq_ckpt_o', type=str, default=None, help='vq ckpt to load.')
        ...
        self.parser.add_argument('--tf_ckpt', type=str, default=None, help='tf ckpt to load.')
        self.parser.add_argument('--mask_prob', type=float, default=0.5, help='mask probability for transformer')
        self.parser.add_argument('--two_stage', type=int, default=0, help='whether to use two-stage classifier or not')
        self.parser.add_argument('--binary_empty_weight', type=float, default=0.5, help='weight for empty class')

        # dataset stuff
        self.parser.add_argument('--dataset_mode', type=str, default='snet', help='chooses how datasets are loaded. [mnist, snet, abc, snet-abc]')
        self.parser.add_argument('--ho_mode', type=str, default='hand', help='for ObMan chooses whether to load hand/object. [hand, object]')
        ...
        self.parser.add_argument('--num_samples', type=int, default=20000, help='number of target sdf samples to use for training')
        ...
        self.parser.add_argument('--load_code', type=int, default=0, help='load extracted code')
        self.parser.add_argument('--load_grid_sdf', type=int, default=0, help='load grid sdf')
        self.parser.add_argument('--load_sparse_sdf', type=int, default=0, help='load sparse sdf')

        
        self.parser.add_argument('--cat', type=str, default='all', help='category for shapenet')
        ...
        self.parser.add_argument('--resnet_test_split_start', type=float, help='start of test split')
        self.parser.add_argument('--resnet_test_split_end', type=float, help='end of test split')
        self.parser.add_argument('--pred_latent', type=int, default=0, help='whether to predict latent code or not')
        self.parser.add_argument('--focal_loss', type=int, default=0, help='whether to use focal loss or not')
        self.parser.add_argument('--label_smoothing', type=float, default=0.0, help='label smoothing')
