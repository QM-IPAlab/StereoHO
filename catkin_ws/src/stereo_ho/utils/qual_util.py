...
from .util_3d import sdf_to_mesh, render_mesh, rotate_mesh_360, render_mesh_with_pose
...
def save_mesh_as_img(mesh_renderer, mesh, pose, out_name='1.png'):
    img = render_mesh_with_pose(mesh_renderer, mesh, pose)
